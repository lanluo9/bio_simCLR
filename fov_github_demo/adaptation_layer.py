            ...
            if 'M' in str(layer_conv):
                ...
                if depth:
                    ...
                    d["conv{}".format(layer_idx)] = nn.Conv2d(
                        ...
                        stride=1, padding=padding_n) # misc_nn_ops.Conv2d
                    d["relu{}".format(layer_idx)] = nn.ReLU(inplace=True)
                    prev_conv = networklist[layer_idx]
...
class adaptation_layers(nn.Module):
    def __init__(self, layers_config, kernel_n =3, padding_n=1, normalize=None, detach=False, depth=False):
        ...
        super().__init__() # https://stackoverflow.com/questions/43751455/supertype-obj-obj-must-be-an-instance-or-subtype-of-type
